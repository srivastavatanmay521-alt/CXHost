...
const reviewsData = [
  {
    ...
    role: 'Bot Developer',
    content:
      'CX HOSTING has been incredible for hosting my Discord bots. The uptime is amazing and support is top-notch!',
    rating: 5,
  },
  {
    name: 'Sarah Chen',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-400 mt-4 max-w-2xl mx-auto">
            Join thousands of satisfied developers and communities who trust CX HOSTING.
          </p>
        </motion.div>
